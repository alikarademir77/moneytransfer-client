...
public class ApplicationConfig {
    ...
    protected ApplicationListener<AuthenticationSuccessEvent> authenticationSuccessEventApplicationListener() {
        return event -> log.info("Authentication Success with principal: {}", event.getAuthentication().getPrincipal());
    }
    ...
    public OAuth2AuthorizedClientManager authorizedClientManager(
        ...
        OAuth2AuthorizedClientProvider authorizedClientProvider =
                OAuth2AuthorizedClientProviderBuilder.builder()
                        .authorizationCode()
                        .refreshToken((builder)->builder.clockSkew(Duration.ofMinutes(5)))
                        .build();
